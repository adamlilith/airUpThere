#' Names WorldClim variables
#'
#' Names of WorldCLim variables. "Standard" and "file" names are provided.
#'
#' @docType data
#'
#' @usage data(wcVars)
...
#'
#' @keywords variables, WorldClim
#'
#' @references
#'
#' @source \href{https://www.worldclim.org/}{WorldClim}
#' 
#' @references
