...
#'	* `wcDownloadHist`: Historical (near-present) climate normals from WorldClim versions 1.4 and 2.1.
#'	* `wcDownloadFut`: Future climate scenario rasters from WorldClim versions 1.4 and 2.1.
